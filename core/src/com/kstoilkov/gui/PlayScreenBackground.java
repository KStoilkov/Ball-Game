...
public class PlayScreenBackground extends Actor implements Disposable{
	...
	private final int BACKGROUND_ANIMATION_SPEED = (int)Config.V_HEIGHT / 30;
	...
	public PlayScreenBackground() {
		...
		this.regionBounds1 = new Rectangle(0, 0, Config.V_WIDTH, Config.V_HEIGHT);
		this.regionBounds2 = new Rectangle(0, Config.V_HEIGHT / 1.1f, Config.V_WIDTH, Config.V_HEIGHT);
	}
	...
	public void draw(Batch batch, float alpha) {
		...
		batch.draw(this.region, this.regionBounds1.x, this.regionBounds1.y, (float)Config.V_WIDTH, (float)Config.V_HEIGHT);
		batch.draw(this.region, this.regionBounds2.x, this.regionBounds2.y, (float)Config.V_WIDTH, (float)Config.V_HEIGHT);
	}
